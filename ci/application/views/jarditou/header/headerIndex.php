...
<!--navbar-expand-sm qui indique à partir de quelle dimension (ici sm, donc à plus de 576px) la barre de navigation sera visible entièrement au lieu d'afficher le bouton hamburger.-->
            <nav class="navbar navbar-expand-sm bg-light navbar-light"> <!--couleur de la barre de navigation-->
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar1">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href=<?= base_url("index.php/jarditou/liste");?>>Tableau</a>
                        </li>
                        <li class="nav-item">
            ...
            <?php if ($_SESSION["status"]  == 1) { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url("index.php/jarditou/admin");?>">Enregistrement administrateur</a>
                        </li>
            <?php } ?>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url("index.php/jarditou/afficherPanier");?>"><div><FONT COLOR="blue"><i class="fas fa-cart-plus fa-2x"></i>(<?= count($_SESSION['panier']);?>)</FONT></div></a>
                        </li>
                        <?php } ?>
                    </ul>
                </div>
